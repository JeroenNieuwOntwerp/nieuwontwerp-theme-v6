...
echo '<section class="contact-information flex row-id-'. $_row_id .' style--'. $_options__style .'" style="margin-top: '. $_options__margin_top .'px !important; margin-bottom: '. $_options__margin_bottom .'px !important;">';
