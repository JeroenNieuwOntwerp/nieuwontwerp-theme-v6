...
echo '<a href="'. $_tile_url .'" rel="noopener nofollow noreferrer" class="cta-tile-icon">
  <img class="cta-tile--image image-id-'. $_tile_image["ID"] .'" src="' . $_tile_image["value"]["url"] . '" alt="'. $_tile_image["value"]["alt"] . '" />
    <h4 class="cta-tile--title" style="color: '. $_tile_textcolour .' !important;">'. $_tile_content .'</h4>';
