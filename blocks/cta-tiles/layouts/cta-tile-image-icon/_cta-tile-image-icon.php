...
echo '<a href="'. $_tile_url .'" rel="noopener nofollow noreferrer" class="cta-tile-image-icon">
  <div class="cta-tile--image-wrapper" style="background-color: '. get_sub_field('icon--background') .'">
    <div class="cta-tile--image--icon--image image-id-'. $_tile_image["ID"] .'" style="background-image: url(' . $_tile_image["value"]["url"] . ');"></div>
  </div>
