...
if( $_options__archive_type == 'custom' )
{
  ...
  if( $_options__archive_type == 'related-products')
  {
    ...
    $_project_args['tax_query'][] = array('taxonomy' => 'related-products', 'terms' =>  $_related_product->name , 'field' => 'name');
  }
...
if( $_options__archive_type == 'custom' )
{
  ...
  {
    $_related_product = get_sub_field('related-products--product');
    $_news_args['tax_query'][] = array('taxonomy' => 'related-products', 'terms' =>  $_related_product->name , 'field' => 'name');
  }
