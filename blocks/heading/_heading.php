...
//
echo '<h'. $_options_size .' class="heading heading-position-'. $_options_position .' heading-id-'. $_content["ID"] .'" style="color: '. $_options_colour .'; margin-top: '. $_options__margin_top .'px !important; margin-bottom: '. $_options__margin_bottom .'px !important;">'. $_content["value"]  .'</h'. $_options_size  .'>';
?>
